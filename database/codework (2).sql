...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=798408664ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=reastaurant&table=reservations">`reastaurant`.`reservations`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=codework&table=mssgusers">`codework`.`mssgusers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=codework&table=freelancer">`codework`.`freelancer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=codework&table=client">`codework`.`client`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=reastaurant&table=foodevents">`reastaurant`.`foodevents`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=reastaurant&table=users">`reastaurant`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=codework&table=post_prj">`codework`.`post_prj`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=codework&table=post_req">`codework`.`post_req`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=codework&table=messages">`codework`.`messages`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="56473b2e4759572e5a3a283d73696b42">
