...
<head>
    ...
    <title>Project - Codify Admin</title>
    <!-- Custom CSS -->
        ...
        ?>
                                            <tr>
                                                ...
                                                <td class="text-nowrap">
                                                    <a href="inc/delete.php?pid=<?=$row['pid']?>" class="btn btn-outline-danger"><i class="fa fa-close text-danger"></i> Remove</a>
                                                </td>
                                            </tr>
<?php
    }
...
?>
    ...
    <script src="javascript/usersadmin.js"></script>
</body>
